...
export const getCurrentPlanDeploymentStatus = createSelector(
  ...
  (currentPlanName, planDeploymentStates) =>
    planDeploymentStates.get(currentPlanName, new DeploymentStatus())
);

export const getCurrentPlanDeploymentIsInProgress = createSelector(
  [getCurrentPlanDeploymentStatus],
  currentPlanDeploymentStatus =>
    [ds.DEPLOYING, ds.UNDEPLOYING, ds.UNKNOWN].includes(
      currentPlanDeploymentStatus.status
    )
);
