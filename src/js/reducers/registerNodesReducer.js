...
export default function registerNodesReducer(state = initialState, action) {
  switch (action.type) {
    case RegisterNodesConstants.ADD_NODE: {
      ...
      return state.update('nodesToRegister', nodes =>
    ...
    case RegisterNodesConstants.REMOVE_NODE: {
      const newState = state.update('nodesToRegister', nodes =>
      ...
      if (action.payload === state.get('selectedNodeId')) {
        ...
        return newState.set(
          'selectedNodeId',
          nodeToSelect ? nodeToSelect.uuid : undefined
        )
      } else {
        return newState
      }
    ...
    case RegisterNodesConstants.UPDATE_NODE: {
      return state.updateIn(
        ['nodesToRegister', action.payload.uuid],
