...
class ContainerImagesWizard extends Component {
  ...
  render() {
    const {
      ...
      containerImagesPrepareFormState
    } = this.props;
    ...
    return (
      ...
      >
        ...
        <Wizard.Footer>
          ...
          {activeStepIndex === 0 && (
            <Button bsStyle="primary" onClick={() => submitImagesPrepareForm()}>
...
ContainerImagesWizard.propTypes = {
  ...
  containerImagesPrepareFormState: PropTypes.object.isRequired,
...
const mapStateToProps = state => ({
  ...
  containerImagesPrepareFormState: {
    error: getFormError('containerImagesPrepareForm')(state)
  }
});
