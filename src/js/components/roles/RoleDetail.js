...
class RoleDetail extends React.Component {
  ...
  */
  ...
  renderRoleTabs() {
    if (this.props.rolesLoaded && !this.props.parametersPending) {
      return (
        <div className="row">
  ...
  render() {
    const dataLoaded = this.props.rolesLoaded && !this.props.parametersPending;
    return (
...
RoleDetail.propTypes = {
  ...
  parametersPending: React.PropTypes.bool.isRequired,
...
function mapStateToProps(state, props) {
  return {
    ...
    parametersPending: state.parameters.isPending,
