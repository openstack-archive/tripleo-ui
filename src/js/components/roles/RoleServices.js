...
class RoleServices extends React.Component {
  ...
  renderServiceTabs() {
    const services = this.props.roleResourceTree.get('services');
    ...
    return (
      <div className="row-eq-height">
        ...
        <div className="col-sm-8">
          <ParameterInputList
            parameters={this.props.roleResourceTree.getIn(['services', this.state.selectedService, 'parameters'], Map())}
