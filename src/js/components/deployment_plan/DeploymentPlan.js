...
class DeploymentPlan extends React.Component {
  ...
  componentWillReceiveProps(nextProps) {
    ...
    this.runPostDeploymentValidations(nextProps.currentStack);
  ...
  runPostDeploymentValidations(nextStack) {
    ...
    if (currentStack
      ...
      this.props.runPostDeploymentValidations.bind(this, currentPlan.name);
    }
  }
