...
class NodeExtendedInfo extends React.Component {
  ...
  renderBios() {
    ...
    return (
      ...
      <div>
        ...
        <dd data-automation="NodeExtendedInfo__bios">
          {bios
  ...
  renderRootDisk() {
    ...
    return (
      ...
      <div>
        ...
        <dd data-automation="NodeExtendedInfo__rootDisk">{rootDisk}</dd>
      </div>
    );
  }
  ...
  renderProduct() {
    ...
    return (
      ...
      <div>
        ...
        <dd>
          <span
            data-automation="NodeExtendedInfo__productName"
          ...
          {' '} - {' '}
          <span
            data-automation="NodeExtendedInfo__productVendor"
          ...
          {' '} | {' '}
          <span
            data-automation="NodeExtendedInfo__productVersion"
  ...
  renderKernel() {
    ...
    return (
      ...
      <div>
        ...
        <dd data-automation="NodeExtendedInfo__kernelVersion">
          {kernelVersion}
        </dd>
      </div>
    );
  ...
  render() {
    ...
    return (
      <Row data-automation="NodeExtendedInfo__extendedInfoRow">
        <Col lg={4} md={6}>
          <dl className="dl-horizontal dl-horizontal-condensed">
            <dt><FormattedMessage {...messages.uuid} /></dt>
            <dd data-automation="NodeExtendedInfo__uuid">{node.get('uuid')}</dd>
            <dt><FormattedMessage {...messages.registered} /></dt>
            <dd data-automation="NodeExtendedInfo__registered">
            ...
            <dd data-automation="NodeExtendedInfo__architecture">
        ...
        <Col lg={4} md={6}>
          <dl className="dl-horizontal dl-horizontal-condensed">
            ...
            <dd data-automation="NodeExtendedInfo__driver">
              {node.get('driver')}
            </dd>
            {node
              .get('driver_info')
              .map((dInfo, key) => (
                <span key={key}>
                  <dt>{startCase(key)}:</dt>
                  <dd data-automation={'NodeExtendedInfo__' + key}>{dInfo}</dd>
                </span>
              ))
              .toList()}
          </dl>
