...
import RegisterNodesConstants from '../../js/constants/RegisterNodesConstants';
...
// describe('Register Nodes Actions', () => {
//   it('creates action to receive nodes', () => {
//     const expectedAction = {
//       type: RegisterNodesConstants.RECEIVE_NODES,
//       payload: mockGetNodesResponse
//     };
//     expect(RegisterNodesActions.receiveNodes(mockGetNodesResponse)).toEqual(expectedAction);
//   });
// });
